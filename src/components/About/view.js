  ...
  return (
    <React.Fragment>
      ...
      <Typography className={styles.textBody}>
        ...
        Spring Boot for the backend, which will handle the logic and database
        connections. The backend will return JSON data to the React frontend via
        rest controllers. This application will be hosted on an undecided cloud
        service so that it can be widely accessible.
      </Typography>
      <br />
